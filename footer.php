        ...
        <div class="row">
            <div class="col footer-col-1">
                ...
                if ($phone_number || $mail_info) : ?>
                    ...
                    <h2 class="footer-sub-heading"><?= pll__('Renalds Steinbergs'); ?></h2>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm col-created-by">
                    <a href="https://martinskepits.lv/" target="_blank"><?= pll__('Built by'); ?> <img src="<?= get_template_directory_uri(); ?>/assets/images/martinskepitslv-logo.svg" alt="Mārtiņš Ķepīts Logo" /></a>
                </div>
            </div>
        </div>
    </div>
